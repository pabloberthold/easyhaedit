...
const VERSION_FEATURES = {
  '2.4': {
    ...
    options: new Set([
      ...
      'allbackups', 'checkcache', 'clitcpka',
      'contstats', 'disable-h2-upgrade', 'dontlognull', 'dontlog-normal',
      'external-check', 'forwardfor',
      'http-buffer-request', 'http-ignore-probes', 'http-keep-alive',
      'http-no-delay', 'http-pretend-keepalive',
      'http-restrict-req-hdr-names', 'http-server-close',
      'http-use-proxy-header', 'idle-close-on-response',
      'http_proxy', 'httpchk', 'httpclose', 'httplog',
      'h1-case-adjust-bogus-client', 'h1-case-adjust-bogus-server',
      'independent-streams', 'ldap-check',
      ...
      'ssl-hello-chk', 'srvtcpka', 'tcp-check',
      'tcp-smart-accept',
    ...
    proxy_dirs_added: new Set([
      ...
      'server', 'server-template', 'default-server',
      ...
      'capture', 'monitor-uri', 'monitor', 'bind', 'filter',
      ...
      'email-alert', 'crt', 'default-server', 'http-error',
      'srvtcpka-cnt',
  ...
  '2.5': {
    ...
    http_request_actions_added: new Set(['wait-for-body', 'set-var-fmt', 'sc-set-gpt']),
  ...
  '2.7': {
    ...
    http_request_actions_added: new Set(['set-bandwidth-limit']),
    server_params_added: new Set([
  ...
  '3.2': {
    ...
    options_added: new Set([
      'host', 'http-drop-request-trailers', 'http-drop-response-trailers',
    ]),
    http_request_actions_added: new Set([]),
    server_params_added: new Set([]),
    bind_params_added: new Set([]),
  ...
  '3.4': {
    ...
    http_request_actions_added: new Set([
      'add-headers-bin', 'del-headers-bin', 'set-headers-bin',
    ]),
    server_params_added: new Set([]),
